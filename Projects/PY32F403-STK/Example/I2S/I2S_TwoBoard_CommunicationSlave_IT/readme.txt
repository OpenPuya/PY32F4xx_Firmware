...
据0x1~0x10，I2S从机接收到数据后，再向I2S主机回发数据0x1~0x10，当I2S主机、I2S
从机成功接收数据时，小灯处于常亮状态，否则小灯处于闪烁状态。

Function descriptions:
This sample demonstrates communication between the I2S master and I2S slave using 
interrupts. The I2S master sends data 0x1 to 0x10 to the I2S slave. The I2S slave
receives the data and sends back data 0x1 to 0x10 to the I2S master. When both
the I2S master and I2S slave successfully receive the data, the LED will be
