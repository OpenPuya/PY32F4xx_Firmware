...
and the LED will turn off, entering sleep mode. When a falling edge is detected 
on PA06, the program will exit sleep mode. The LED will toggle at intervals 
of 500ms.
