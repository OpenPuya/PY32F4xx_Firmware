...
1. 编译下载程序到MCU，并运行
2. 将PB12引脚接低电平。
3. 使用逻辑分析仪观察引脚PA8/PA9/PA10/PB13/PB14/PB15的波形；
4. 将PB12引脚接高电平，PWM停止输出。

Example execution steps:
1.Compile and download the program to the MCU, and then run it.
2.Set pin PB12 to the low logic level.
3.Use a logic analyzer to observe the waveforms on pins PA8/PA9/PA10/PB13/PB14/PB15.
4.Set pin PB12 to a high logic level to stop PWM output.
================================================================================
注意事项：
PA8  -> CH1  占空比：25%
PA9  -> CH2  占空比：50%
